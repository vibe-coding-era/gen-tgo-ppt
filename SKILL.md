...
description: 生成或改造 TGO鲲鹏会 / GTLC 风格 PPT 与 HTML 演示稿。适用于从 PPT、PDF、Markdown、HTML、粘贴内容或既有演示稿生成、套版、修复、校验 TGO/GTLC 演示材料；必须使用 v0.81 工作流、渐进式加载独立规则文件、生成日志、标题页后嘉宾介绍页、末尾感谢聆听页、排版安全检查、逐页渲染校对，以及“生成内容/检查风格/检查文字”职责分离。
---
...
| 排版、溢出、半尺寸画布、首尾页、项目基本信息页 | `references/rule-layout-safety-v081.md` | `references/rule-page-styles.md` |
