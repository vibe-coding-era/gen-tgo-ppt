# TGO Presentation Design System v1.0

This legacy entrypoint has been split for progressive loading.

Show the preview image from:

- `assets/design/previews/styles/tgo-presentation-design-system-v1.png`

Then use `references/design/index.md` to load only the selected visual-style `design.md` files:
